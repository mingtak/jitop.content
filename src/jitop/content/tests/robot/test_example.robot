...
#
#  $ bin/test -s jitop.content -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src jitop.content.testing.JITOP_CONTENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/jitop/content/tests/robot/test_example.robot
#
